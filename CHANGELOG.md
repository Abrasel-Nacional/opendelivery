...
- Added endpoint [GET /merchant/{id}/status](https://abrasel-nacional.github.io/opendelivery/#operation/getMerchantAvailability) to retrieve merchant status, service hours, and orderingAppMerchantId.

- [PUT /merchantOnboarding](https://abrasel-nacional.github.io/opendelivery/#operation/putMerchantOnboarding)
...
- [PATCH /orders/{orderId}/details](https://abrasel-nacional.github.io/opendelivery/#operation/patchOrderDetails)
  - New endpoint created to allow targeted updates to order properties that do not affect the order status.
          
#### LOGISTICS changes

- [POST /logistics/delivery](https://abrasel-nacional.github.io/opendelivery/#operation/logisticsNewDelivery)
...
- Added two new optional order events:  
  ...
  **PICKED_UP**: Informs the **Ordering Application** that the order has been picked up by the customer.  
  ...
  - Added new [POST /v1/orders/{orderId}/preparing](https://abrasel-nacional.github.io/opendelivery/#operation/orderPreparing) endpoint.
  - Added new [POST /v1/orders/{orderId}/pickedUp](https://abrasel-nacional.github.io/opendelivery/#operation/orderPickedUp) endpoint.  
  
  - [GET /events:polling](https://abrasel-nacional.github.io/opendelivery/#operation/pollingEvents) || [POST /events/acknowledgment](https://abrasel-nacional.github.io/opendelivery/#operation/pollingAcknowledgment) || [POST /orderUpdate](https://abrasel-nacional.github.io/opendelivery/#operation/newEvent)
...
- [GET /merchant](https://abrasel-nacional.github.io/opendelivery/#operation/getMerchant)
...
- [GET v1/events:polling ](https://abrasel-nacional.github.io/opendelivery/#operation/pollingEvents)
- [POST /orderUpdate (WEBHOOK)](https://abrasel-nacional.github.io/opendelivery/#operation/newEvent)
- [GET /v1/orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/#operation/ordersDetails)
...
- [POST /v1/orders/{orderId}/validateCode](https://abrasel-nacional.github.io/opendelivery/#operation/orderValidateDelivery)
...
- Other ORDERS changes:
  ...
  - The diagram of the [Order Cancellation section](https://abrasel-nacional.github.io/opendelivery/#tag/ordersCancellation), where Ordering Application's cancellation is explained, has been updated to better reflect event returns.
...
- [POST /v1/logistics/readyForPickup/{orderId}](https://abrasel-nacional.github.io/opendelivery/#operation/logisticsReadyForPickup)
...
- [POST v1/logistics/delivery](https://abrasel-nacional.github.io/opendelivery/#operation/logisticsNewDelivery)  
...
- [POST v1/logistics/confirmationCode (WEBHOOK)](https://abrasel-nacional.github.io/opendelivery/#operation/logistictsDeliveryCode)
...
- [GET /v1/orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/#tag/ordersDetails/operation/ordersDetails)
...
- [POST /logistics/delivery](https://abrasel-nacional.github.io/opendelivery/#tag/logisticOrder/operation/logisticsNewDelivery)
...
#### ORDERS changes
  ...
  - [GET /v1/orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/versions/1.2.1/#tag/ordersDetails/operation/ordersDetails)
...
- [POST /orders/{orderId}/tracking](https://abrasel-nacional.github.io/opendelivery/#tag/ordersTracking/operation/orderTracking)

  - Added a new endpoint [POST /orders/{orderId}/tracking](https://abrasel-nacional.github.io/opendelivery/#operation/orderTracking) for sending delivery information to the `Ordering Application`.

- [GET /v1/orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/#tag/ordersDetails/operation/ordersDetails)

  - Added new optional field `sendTracking` to control whether or not the `Software Service` should call the [POST /orders/{orderId}/tracking](https://abrasel-nacional.github.io/opendelivery/#operation/orderTracking) endpoint.
...
- [POST /v1/orders/{orderId}/dispatch](https://abrasel-nacional.github.io/opendelivery/#tag/ordersStatus/operation/dispatchOrder)
...
- [POST /v1/orders/{orderId}/requestCancellation](https://abrasel-nacional.github.io/opendelivery/#tag/ordersCancellation/operation/requestCancellation)

  - Added `DELIVERY_PROBLEM` as a new enum option to the `code` propertie. 

- [GET /v1/events:polling ](https://abrasel-nacional.github.io/opendelivery/#tag/ordersPolling/operation/pollingEvents)

  - Removed the requirement of the `x-polling-merchants` parameter.

#### LOGISTICS changes

- [POST /v1/logistics/delivery](https://abrasel-nacional.github.io/opendelivery/#tag/logisticOrder/operation/logisticsNewDelivery)
...
- [POST /v1/logistics/availability](https://abrasel-nacional.github.io/opendelivery/#tag/logisticPrice/operation/logisticsAvailability)

  - Added a new optional field `orderDeliveryFee` to inform to the `Logistics Service` the customer's paid shipping fee in the `Ordering Application`

- [GET /v1/logistics/delivery/{orderId}](https://abrasel-nacional.github.io/opendelivery/#tag/logisticDetails/operation/logisticDetails)

  - Fixed the `problem.actionTaken` propertie type to string instead of boolean

#### SECURITY changes

- [POST /oauth/token](https://abrasel-nacional.github.io/opendelivery/#tag/authentication/operation/getToken)
...
- [GET /v1/merchant](https://abrasel-nacional.github.io/opendelivery/#tag/merchantEndpoints/operation/getMerchant)
...
- [GET /v1/orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/#tag/ordersDetails/operation/ordersDetails)
    ...
    - added `sendDelivered` property. This property should have been added together with the [POST /v1/orders/{orderId}/delivered](https://abrasel-nacional.github.io/opendelivery/#operation/orderDelivered) endpoint  

    - added `CANCELLATION_DENIED` to the order events. This event was described in the documentation in the [Orders Cancellation](https://abrasel-nacional.github.io/opendelivery/#tag/ordersCancellation) section but was not present in the enum.
...
- [GET /v1/merchant](https://abrasel-nacional.github.io/opendelivery/#tag/merchantEndpoints/operation/getMerchant)
  ...
  - added an enumerator to propertie `unit` in the `items` entity of endpoint [GET /v1/merchant](https://abrasel-nacional.github.io/opendelivery/#tag/merchantEndpoints/operation/getMerchant).

  - added new optional field `targetAppId` in the `service` entity of endpoint [GET /v1/merchant](https://abrasel-nacional.github.io/opendelivery/#tag/merchantEndpoints/operation/getMerchant).

      This field is intended to indicate a specific Ordering Application to receive the service information.

- [POST /v1/merchantUpdated](https://abrasel-nacional.github.io/opendelivery/#tag/merchantUpdate/operation/menuUpdated)

  - added `MERCHANT` and `BASIC_INFO` options to the enumerator of the `entityType` field of the webhook.

    This allows the webhook to now receive the full merchant entity information and can be used instead of the [GET /v1/merchant](https://abrasel-nacional.github.io/opendelivery/#tag/merchantEndpoints/operation/getMerchant) endpoint.  
...
- added a new optional order event, called `DELIVERED`.  
  ...
  - added new [POST /v1/orders/{orderId}/delivered](https://abrasel-nacional.github.io/opendelivery/#tag/ordersStatus/operation/orderDelivered) endpoint
...
- [POST /v1/orders/{orderId}/confirm](https://abrasel-nacional.github.io/opendelivery/#tag/ordersStatus/operation/confirmOrder)
...
## Version [1.0.1] - Aug 1, 2022
  ...
  With this the following changes were made:
    ...
    - [GET /merchant](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/merchantEndpoints/operation/getMerchant)
      ...
      ...
      ```
    - [GET /orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersDetails/operation/ordersDetails)
  ...
  - Added a new service type called **INDOOR**.  
    ...
    - [GET /orders/{orderId}](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersDetails/operation/ordersDetails)
      ...
      ```
  - Added a new endpoint so that **Merchant** can send information related to its [GET /merchant](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/merchantEndpoints/operation/getMerchant) endpoint to the **Ordering APPLICATION**:

    - [PUT /v1/merchantOnboarding](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/merchantStatus/operation/putMerchantOnboarding) 

  - Added a new [Working Versions](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/versionsSection) section with endpoints so that both the Software Service and the Ordering Application can check which version of the Open Delivery API the other end is using. The endpoints created were:

    - [GET /v1/versions/orderingApp](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/https://abrasel-nacional.github.io/opendelivery/#operation/getOrderingAppVersions)
    - [GET /v1/versions/merchant](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/merchantEndpoints/operation/getMerchantVersions)

  - Added the `status` property to entities `Item`, `ItemOffer` and `Option` on the [GET /merchant](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/merchantEndpoints/operation/getMerchant) endpoint.

  - Added HTTP Status code 422 on the following endpoints:
    - [POST /v1/orders/{orderId}/confirm](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/operation/confirmOrder)
    - [POST /v1/orders/{orderId}/readyForPickup](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/orderReady)
    - [POST /v1/orders/{orderId}/dispatch](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/dispatchOrder)
    - [POST /v1/orders/{orderId}/requestCancellation](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/requestCancellation)
    - [POST /v1/orders/{orderId}/acceptCancellation](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/cancellationAccepted)
    - [POST /v1/orders/{orderId}/denyCancellation](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/cancellationDenied)

  - Added HTTP Status code 204 on the following endpoints:
    - [POST /v1/merchantUpdated](https://abrasel-nacional.github.io/opendelivery/#tag/merchantUpdate/operation/menuUpdated)
    - [POST /v1/orderUpdate](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersWebhook/operation/newEvent)
    - [POST /v1/orders/{orderId}/acceptCancellation](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/cancellationAccepted)
    - [POST /v1/orders/{orderId}/denyCancellation](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersStatus/https://abrasel-nacional.github.io/opendelivery/#operation/cancellationDenied)
  ...
  - Added a new [Developer Tools](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#section/Developer-Tools) section where links to partner tools to help with API development will be listed.

  - [Order Overview](https://abrasel-nacional.github.io/opendelivery/versions/1.0.1/#tag/ordersOverview)
